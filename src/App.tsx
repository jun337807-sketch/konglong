...
export default function App() {
  ...
  return (
    <div className="flex h-screen w-full bg-zinc-950 text-zinc-300 font-sans overflow-hidden selection:bg-[#FFC107] selection:text-black">
      {/* Sidebar */}
      ...
      {showInfiniteCanvas && (
        <InfiniteCanvasWrapper onClose={() => setShowInfiniteCanvas(false)} />
      )}
    </div>
  );
}
